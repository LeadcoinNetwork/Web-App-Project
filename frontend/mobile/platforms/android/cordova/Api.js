...
function Api(platform, platformRootDir, events) {
  ...
  if (AndroidStudio.isAndroidStudioProject(self.root) === true) {
    ...
    this.locations.configXml = path.join(
      self.root,
      "app/src/main/res/xml/config.xml",
    )
    this.locations.strings = path.join(
      self.root,
      "app/src/main/res/values/strings.xml",
    )
    this.locations.manifest = path.join(
      self.root,
  ...
  return (
    Q()
      .then(function() {
        ...
        if (
          !AndroidStudio.isAndroidStudioProject(self.root) &&
          !project.isClean()
        ) {
...
Api.prototype.removePlugin = function(plugin, uninstallOptions) {
  ...
  if (
    uninstallOptions &&
    uninstallOptions.usePlatformWww === true &&
    this.android_studio === true
  ) {
