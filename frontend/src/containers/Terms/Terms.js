  ...
  <div className="terms">
    ...
    <div>
      <p>
        ...
        http://www.leadcoin.network website and the LeadCoin Mobile App mobile
        application operated by LeadCoin.
      </p>
      <p>
    ...
    <div>
      ...
      <p>
        ...
        card number, the expiration date of your credit card and your billing
        address.
      </p>
      <p>
      ...
      <p>
        The Services may employ the use of third party services for the purpose
    ...
    <div>
      ...
      <p>
        ...
        ("Content"). You are responsible for the content that you post and
        responsible for making sure that this content abides by the guidelines
        set by LeadCoin for appropriate content.
      </p>
    </div>
    <div>
      ...
      <p>
        ...
        are not owned or controlled by LeadCoin.
      </p>
      <p>
        LeadCoin has no control over, and assumes no responsibility for, the
        content, privacy policies, or practices of any third party web sites or
        services. You further acknowledge and agree that LeadCoin shall not be
