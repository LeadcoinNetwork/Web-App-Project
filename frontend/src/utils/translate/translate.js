...
function getRandom(language, original) {
  const randomSource = {
    zh: "你好吗 喂 請問 这是什么 在哪里 别管我 常来    这儿吗 我不知道 是的 当 懈 关 所以 一個 找到 回家",
    ja: "いですよ どうたして  すみせん どうぞ   それは何ですか まずいです いただきます 英語 危ない 質問 どこ",
    ko: "풀, 잔 살 고기 알 보다 떨어지 빨 씻다 매 별 부드럽 안녕하세요 맥주/소 잘 모르겠네 얼마에 교환해 주세",
  }
  let str = ''
